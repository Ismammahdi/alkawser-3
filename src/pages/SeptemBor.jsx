...
const SeptemBor = () => {
  ...
  return (
    <div className="pt-24">
      {/* Banner Section */}
      {/* <div
        className="relative min-w-full bg-cover bg-top w-full h-40 md:h-56 flex items-center font-bengali "
        style={{
            ...
            <div className="flex flex-col items-center space-y-2 md:space-y-0 md:flex-row md:items-center md:justify-between md:space-x-4">
              ...
              <div className="w-full md:w-[40%] font-bengali text-center md:text-left">
                <div className="flex flex-col items-center md:flex-row md:items-center">
                  <h2 className="text-3xl text-white font-normal pb-1 flex-grow md:pb-[10px] border-b border-yellow-500">
